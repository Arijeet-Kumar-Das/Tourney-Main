...
const TournamentManagement = () => {
  ...
  const handleConfirmAction = async () => {
    ...
    try {
      ...
      else if (confirmDialog.action === "feature") url += "/feature";
      ...
      setSnackbar({
        ...
        message:
          confirmDialog.action === "approve"
            ...
            ? (confirmDialog.tournament?.isFeatured ? "Removed from featured" : "Marked as featured")
            : "Tournament deleted",
        severity: "success",
      });
                ...
                >
                  ...
                  <Stack direction="row" spacing={2}>
                    ...
                    <Button
                      ...
                      onClick={() => handleAction("feature", tournament)}
                    >
      ...
      >
        <DialogTitle>
          {confirmDialog.action === "approve"
            ...
            ? "Reject Tournament"
            : confirmDialog.action === "feature"
            ? (confirmDialog.tournament?.isFeatured ? "Remove Featured" : "Mark as Featured")
            : "Delete Tournament"}
        </DialogTitle>
        <DialogContent>
          <Typography>
            ...
            {confirmDialog.action === "approve"
              ...
              ? "reject"
              : confirmDialog.action === "feature"
              ? (confirmDialog.tournament?.isFeatured ? "unfeature" : "feature")
              : "delete"}{" "}
