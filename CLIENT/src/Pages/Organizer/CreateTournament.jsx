...
const CreateTournament = () => {
  ...
  const handleNextStep = () => {
    if(!formData.tournamentName || !formData.tournamentType || !formData.sport || !formData.startDate || !formData.endDate || !formData.address || !formData.coverImage){
      ...
      <div className="create-tournament-container-full">
        ...
        <div className="create-tournament-card-full">
          ...
          <form className="create-tournament-form-full">
              ...
              <div className="create-tournament-radio-group-full">
                <label className="create-tournament-radio-option-full">
                  <input
                    ...
                    onChange={()=>setFormData(prev=>({...prev,isFeatured:true}))}
                    className="create-tournament-radio-full"
                  />
                  <span className="create-tournament-radio-label-full">Featured</span>
                </label>
                <label className="create-tournament-radio-option-full">
                  <input
                    type="radio"
                    ...
                    onChange={()=>setFormData(prev=>({...prev,isFeatured:false}))}
                    className="create-tournament-radio-full"
                  />
                  <span className="create-tournament-radio-label-full">Not Featured</span>
                </label>
              </div>
            </div>
            ...
            <div className="create-tournament-form-group-full">
              <label className="create-tournament-label-full">
                Tournament Address <span className="create-tournament-required-full">*</span>
              </label>
              <input
                type="text"
                name="address"
            ...
            <div className="create-tournament-form-group-full">
              ...
              <input
                ...
                className="create-tournament-input-full"
              />
              <small className="create-tournament-help-text">
                Optional: Paste Google Maps link for easy navigation
              </small>
            </div>
